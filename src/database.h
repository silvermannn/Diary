...
private:
    ...
    QDate fromDelphiDate(qint64 days);
...
// TODO: Implement those all
    ...
    void fetchExInfo(int id, QStringList& paramNames, QStringList& paramValues, QStringList& paramUnits, QString& comment, QStringList &comments, QString &lastComment);
    ...
    bool fetchFoodIntake(int id, QDate& date, int& idFood, double& amount, QString& comment);
